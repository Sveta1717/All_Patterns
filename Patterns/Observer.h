...
public:
    ...
    void HowManyObserver()
    {
     ...
     // ќбычно логика подписки Ц только часть того, что делает »здатель. »здатели часто содержат
     // некоторую важную бизнес-логику, котора€ запускает метод уведомлени€ вс€кий раз, когда должно 
     // произойти что-то важное (или после этого).
